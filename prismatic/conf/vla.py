...
# = [1 GPU] Testing validation adding
@dataclass
class Exp_DinoSigLIP_SlotAtt_224px_Droid_TrainValTest(VLAConfig):
    vla_id: str = "prism-dinosiglip-slotatt-224px+mx-droid-trainval"
    base_vlm: Union[str, Path] = "prism-dinosiglip-slotatt-224px+7b"
    ...
    data_mix: str = "droid"
    shuffle_buffer_size: int = 100 # 256_000 # 256_000
...
# = [1 GPU] Testing validation adding
@dataclass
class Exp_DinoSigLIP_224px_Droid_TrainValTest(VLAConfig):
    vla_id: str = "prism-dinosiglip-224px+mx-droid-trainval"
    ...
    # Note =>> We adopt two stages, training on a mixture including DROID for 70% of training, before resampling!
    data_mix: str = "droid"
    shuffle_buffer_size: int = 256_000 # 256_000

    # Optimization Parameters
    epochs: int = 20
    max_steps: Optional[int] = 21000 # 1000000
...
# = [04 GPU] DINO-SigLIP 224px + DROID =
@dataclass
...
class VLARegistry(Enum):
    ...
    # [OpenVLA 7B] DINO + SigLIP 224px + DROID TRAINVALTEST
    DINOSIGLIP_224PX_MX_DROID_TRAINVALTEST = Exp_DinoSigLIP_224px_Droid_TrainValTest

    # [OpenVLA 7B] DINO + SigLIP 224px + DROID TRAINVALTEST
    DINOSIGLIP_SLOTATT_224PX_MX_DROID_TRAINVALTEST = Exp_DinoSigLIP_SlotAtt_224px_Droid_TrainValTest

    # [OpenVLA 7B] DINO + SigLIP 224px + DROID
