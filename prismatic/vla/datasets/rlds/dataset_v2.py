...
def make_dataset_from_rlds(
    ...
    *,
    ...
    def restructure(traj):
        ...
        for new, old in image_obs_keys.items():
            if old is None:
                ...
                new_obs[f"image_{new}_seg"] = tf.repeat("", traj_len)  # padding
            else:
                new_obs[f"image_{new}"] = old_obs[old]
                new_obs[f"image_{new}_seg"] = old_obs[old + "_seg"]
        ...
        if "image_reasoning" in old_obs:
            new_obs["reasoning_on_image"] = tf.cast(old_obs["image_reasoning"], tf.string) 
        if "wrist_image_reasoning" in old_obs: 
            new_obs["reasoning_on_wrist_image"] = tf.cast(old_obs["wrist_image_reasoning"], tf.string)
        ...
        if "language_instruction_nouns" in traj:
            task["language_instruction_nouns"] = traj.pop("language_instruction_nouns")
    ...
    if 'droid' in name:
        builder = tfds.builder_from_directory(builder_dir=data_dir + '/droid/droid_dataset/1.0.0')
    elif 'real_action' in name:
        builder = tfds.builder_from_directory(builder_dir=data_dir + '/physical_01/data_20250304/custom_ur10e_real_action/1.0.0')
    elif 'real' in name:
        builder = tfds.builder_from_directory(builder_dir=data_dir + '/physical_01/data_20250304/custom_ur10e_real/1.0.0')
    elif 'robomimic_lift' in name:
        builder = tfds.builder_from_directory(builder_dir=data_dir + '/robomimic_ph/rlds_datasets/lift/lift/lift_ph_image/1.0.1')
    elif 'robomimic_can' in name:
        builder = tfds.builder_from_directory(builder_dir=data_dir + '/robomimic_ph/rlds_datasets/can/can/can_ph_image/1.0.1')
    elif 'robomimic_square' in name:
        builder = tfds.builder_from_directory(builder_dir=data_dir + '/robomimic_ph/rlds_datasets/square/square/square_ph_image/1.0.1')
    elif 'robomimic_tool_hang' in name:
        builder = tfds.builder_from_directory(builder_dir=data_dir + '/robomimic_ph/rlds_datasets/tool_hang/tool_hang/tool_hang_ph_image/1.0.1')
    elif 'libero_spatial' in name:
        builder = tfds.builder_from_directory(builder_dir=data_dir + '/libero/rlds_datasets/libero_spatial/1.0.0')
    elif 'libero_object' in name:
        builder = tfds.builder_from_directory(builder_dir=data_dir + '/libero/rlds_datasets/libero_object/1.0.0')
    elif 'libero_goal_oc' in name:
        builder = tfds.builder_from_directory(builder_dir=data_dir + '/libero/rlds_datasets/libero_goal_oc/libero_goal/1.0.0')
    elif 'libero_goal' in name:
        builder = tfds.builder_from_directory(builder_dir=data_dir + '/libero/rlds_datasets/__revised_v4/libero_goal/1.0.0')
        # builder = tfds.builder_from_directory(builder_dir=data_dir + '/libero/rlds_datasets/__revised_v2/libero_goal/1.0.0')
        # builder = tfds.builder_from_directory(builder_dir=data_dir + '/libero/rlds_datasets/__small/libero_goal/1.0.0')
        # builder = tfds.builder_from_directory(builder_dir=data_dir + '/libero/rlds_datasets/libero_goal/1.0.0')
    elif 'libero_10' in name:
        builder = tfds.builder_from_directory(builder_dir=data_dir + '/libero/rlds_datasets/liber_o10/1.0.0')
    elif 'libero_relation' in name:
        builder = tfds.builder_from_directory(builder_dir=data_dir + '/libero/rlds_datasets/libero_relation/1.0.0')
...
# === Core Initializer ===
def make_interleaved_dataset_v2(
