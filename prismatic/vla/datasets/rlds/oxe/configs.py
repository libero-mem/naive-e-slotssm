...
OXE_DATASET_CONFIGS = {
    ...
    "robomimic_lift": {
        "image_obs_keys": {"primary": "agentview_image", "secondary": None, "wrist": "robot0_eye_in_hand_image"},
        "depth_obs_keys": {"primary": None, "secondary": None, "wrist": None},
        "state_obs_keys": ["proprio"],
        "state_encoding": StateEncoding.POS_EULER,
        "action_encoding": ActionEncoding.EEF_POS,
    ...
    "robomimic_tool_hang": {
        "image_obs_keys": {"primary": "sideview_image", "secondary": None, "wrist": "robot0_eye_in_hand_image"},
        "depth_obs_keys": {"primary": None, "secondary": None, "wrist": None},
        "state_obs_keys": ["proprio"],
        "state_encoding": StateEncoding.POS_EULER,
        "action_encoding": ActionEncoding.EEF_POS,
    ...
    "libero_goal": {
        "image_obs_keys": {"primary": "image", "secondary": None, "wrist": "wrist_image"},
        "depth_obs_keys": {"primary": "image_depth", "secondary": None, "wrist": "wrist_image_depth"},
        "state_obs_keys": ["state"],
        "state_encoding": StateEncoding.POS_EULER,
        "action_encoding": ActionEncoding.EEF_POS,
    },
    ...
    "real_action": {
        "image_obs_keys": {"primary": "wrist_image_left", "secondary": None, "wrist": None},
        "depth_obs_keys": {"primary": None, "secondary": None, "wrist": None},
        "state_obs_keys": ["state"],
        "state_encoding": StateEncoding.POS_EULER,
        "action_encoding": ActionEncoding.EEF_POS,
