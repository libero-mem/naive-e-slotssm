...
def make_dataset_from_rlds(
    ...
    *,
    ...
    if 'droid' in name:
        ...
        builder = tfds.builder_from_directory(builder_dir='./real_data/1.0.0')
        ...
        builder = tfds.builder_from_directory(builder_dir=data_dir + '/libero/rlds_datasets/libero_object_oc/libero_object/1.0.0')
    elif 'libero_spatial' in name:
        builder = tfds.builder_from_directory(builder_dir=data_dir + '/libero/rlds_datasets/libero_spatial_oc/libero_spatial/1.0.0')
    elif 'libero_10' in name:
        builder = tfds.builder_from_directory(builder_dir=data_dir + '/libero/rlds_datasets/liber_o10_oc/liber_o10/1.0.0')
...
# === Core Initializer ===
def make_interleaved_dataset_v3(
    ...
    *,
    ...
    # return dataset, dataset_len, all_dataset_statistics[dataset_kwargs["name"]]
    # 1/0
