...
class LIBERO_MEM(Benchmark):
    def __init__(self, task_order_index=22):
        super().__init__(task_order_index=task_order_index)
        self.name = "libero_mem"
        self._make_benchmark()


@register_benchmark
class LIBERO_RELATION(Benchmark):
    def __init__(self, task_order_index=21):
        super().__init__(task_order_index=task_order_index)
        self.name = "libero_relation"
        self._make_benchmark()
